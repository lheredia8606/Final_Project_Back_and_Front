...
export const ProductQtyFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ProductQtySelect> = z.object({
...
export const ProductQtyFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    orderId: z.boolean().optional(),
    productId: z.boolean().optional(),
    qty: z.boolean().optional(),
...
export const ProductQtyFindFirstOrThrowSchema: z.ZodType<Prisma.ProductQtyFindFirstOrThrowArgs> = z.object({ select: ProductQtyFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProductQtyIncludeObjectSchema.optional()), orderBy: z.union([ProductQtyOrderByWithRelationInputObjectSchema, ProductQtyOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductQtyWhereInputObjectSchema.optional(), cursor: ProductQtyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductQtyScalarFieldEnumSchema, ProductQtyScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductQtyFindFirstOrThrowArgs>;

export const ProductQtyFindFirstOrThrowZodSchema = z.object({ select: ProductQtyFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProductQtyIncludeObjectSchema.optional()), orderBy: z.union([ProductQtyOrderByWithRelationInputObjectSchema, ProductQtyOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductQtyWhereInputObjectSchema.optional(), cursor: ProductQtyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductQtyScalarFieldEnumSchema, ProductQtyScalarFieldEnumSchema.array()]).optional() }).strict();