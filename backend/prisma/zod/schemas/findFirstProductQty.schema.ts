...
export const ProductQtyFindFirstSelectSchema: z.ZodType<Prisma.ProductQtySelect> = z.object({
...
export const ProductQtyFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    orderId: z.boolean().optional(),
    productId: z.boolean().optional(),
    qty: z.boolean().optional(),
...
export const ProductQtyFindFirstSchema: z.ZodType<Prisma.ProductQtyFindFirstArgs> = z.object({ select: ProductQtyFindFirstSelectSchema.optional(), include: z.lazy(() => ProductQtyIncludeObjectSchema.optional()), orderBy: z.union([ProductQtyOrderByWithRelationInputObjectSchema, ProductQtyOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductQtyWhereInputObjectSchema.optional(), cursor: ProductQtyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductQtyScalarFieldEnumSchema, ProductQtyScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductQtyFindFirstArgs>;

export const ProductQtyFindFirstZodSchema = z.object({ select: ProductQtyFindFirstSelectSchema.optional(), include: z.lazy(() => ProductQtyIncludeObjectSchema.optional()), orderBy: z.union([ProductQtyOrderByWithRelationInputObjectSchema, ProductQtyOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductQtyWhereInputObjectSchema.optional(), cursor: ProductQtyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductQtyScalarFieldEnumSchema, ProductQtyScalarFieldEnumSchema.array()]).optional() }).strict();