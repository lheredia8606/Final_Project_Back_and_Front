...
export const ProductsFindFirstSelectSchema: z.ZodType<Prisma.ProductsSelect> = z.object({
...
export const ProductsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    type: z.boolean().optional(),
    name: z.boolean().optional(),
    inStock: z.boolean().optional(),
...
export const ProductsFindFirstSchema: z.ZodType<Prisma.ProductsFindFirstArgs> = z.object({ select: ProductsFindFirstSelectSchema.optional(), include: z.lazy(() => ProductsIncludeObjectSchema.optional()), orderBy: z.union([ProductsOrderByWithRelationInputObjectSchema, ProductsOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductsWhereInputObjectSchema.optional(), cursor: ProductsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductsScalarFieldEnumSchema, ProductsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductsFindFirstArgs>;

export const ProductsFindFirstZodSchema = z.object({ select: ProductsFindFirstSelectSchema.optional(), include: z.lazy(() => ProductsIncludeObjectSchema.optional()), orderBy: z.union([ProductsOrderByWithRelationInputObjectSchema, ProductsOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductsWhereInputObjectSchema.optional(), cursor: ProductsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductsScalarFieldEnumSchema, ProductsScalarFieldEnumSchema.array()]).optional() }).strict();