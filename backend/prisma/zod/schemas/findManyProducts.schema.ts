...
export const ProductsFindManySelectSchema: z.ZodType<Prisma.ProductsSelect> = z.object({
...
export const ProductsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    type: z.boolean().optional(),
    name: z.boolean().optional(),
    inStock: z.boolean().optional(),
...
export const ProductsFindManySchema: z.ZodType<Prisma.ProductsFindManyArgs> = z.object({ select: ProductsFindManySelectSchema.optional(), include: z.lazy(() => ProductsIncludeObjectSchema.optional()), orderBy: z.union([ProductsOrderByWithRelationInputObjectSchema, ProductsOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductsWhereInputObjectSchema.optional(), cursor: ProductsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductsScalarFieldEnumSchema, ProductsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductsFindManyArgs>;

export const ProductsFindManyZodSchema = z.object({ select: ProductsFindManySelectSchema.optional(), include: z.lazy(() => ProductsIncludeObjectSchema.optional()), orderBy: z.union([ProductsOrderByWithRelationInputObjectSchema, ProductsOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductsWhereInputObjectSchema.optional(), cursor: ProductsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductsScalarFieldEnumSchema, ProductsScalarFieldEnumSchema.array()]).optional() }).strict();