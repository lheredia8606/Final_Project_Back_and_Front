...
import { ProductQtyOrderIdProductIdCompoundUniqueInputObjectSchema as ProductQtyOrderIdProductIdCompoundUniqueInputObjectSchema } from './ProductQtyOrderIdProductIdCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.number().int().optional(),
  orderId_productId: z.lazy(() => ProductQtyOrderIdProductIdCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["orderId","productId"]] as string[][];
...
export const ProductQtyWhereUniqueInputObjectSchema: z.ZodType<Prisma.ProductQtyWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.ProductQtyWhereUniqueInput>;
export const ProductQtyWhereUniqueInputObjectZodSchema = makeSchema();
